...
class PageRevel extends StatelessWidget {
  final double revealPercent;
  final Widget child;

  PageRevel({this.revealPercent, this.child});

  @override
  Widget build(BuildContext context) {
    return ClipOval(child: child, clipper: new CircleRevealClipper(revealPercent: revealPercent));
  }
}
